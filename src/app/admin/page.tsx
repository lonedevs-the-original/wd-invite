...
import { ArrowUpRight, CalendarDays, CheckCircle2, Clock3, Eye, MoreHorizontal, Plus, Users } from "lucide-react";
    ...
    <main className="px-5 pb-16 pt-6 sm:px-8 lg:px-12 lg:pt-10">
      ...
      <section className="mx-auto mt-8 max-w-6xl overflow-hidden rounded-2xl border border-[#e4e2dd] bg-white">
        <div className="flex items-center justify-between border-b border-[#eceae6] px-5 py-4">
          ...
          <details className="relative"><summary aria-label="Qo‘shimcha menyu" className="cursor-pointer list-none rounded-lg border border-[#e4e2dd] p-2"><MoreHorizontal size={18} /></summary><div className="absolute right-0 z-20 mt-2 w-48 rounded-xl border bg-white p-2 text-sm shadow-xl"><Link href="/admin/guests" className="block rounded-lg px-3 py-2 hover:bg-[#f5f2ee]">Mehmonlar</Link><Link href="/admin/settings" className="block rounded-lg px-3 py-2 hover:bg-[#f5f2ee]">Sozlamalar</Link><Link href="/privacy" className="block rounded-lg px-3 py-2 hover:bg-[#f5f2ee]">Maxfiylik</Link></div></details>
        </div>
