...
export default function Home() {
  ...
  return <main className="min-h-screen overflow-hidden bg-[#f7f3ec] text-[#27231f]">
    ...
    <section className="px-6 py-16 text-center"><h2 className="font-serif text-4xl">LoneDevs bilan bog‘lanish</h2><p className="mx-auto mb-7 mt-3 max-w-xl text-[#746a62]">Takliflar, muammolar yoki loyihani qo‘llab-quvvatlash uchun.</p><CreatorActions/></section>
  </main>;
}
